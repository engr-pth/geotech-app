...
if selected == "Home":
    ...
    * **Shallow Foundation Design တွက်ချက်ရန်:**
    ...
    # Soil classification အတွက် ရေးထားသမျှ Code များကို ဒီအောက်မှာ ထည့်ပါ
import streamlit as st
import numpy as np
...
with col_res:
    ...
    # Isolated Footing အတွက် ရေးထားသမျှ Code များကို ဒီအောက်မှာ ထည့်ပါ


elif selected == "Continuous Wall Footing":
    st.title("🧱 Continuous Wall Footing Design Suite")
    # Continuous Wall Footing အတွက် ရေးထားသမျှ Code များကို ဒီအောက်မှာ ထည့်ပါ
    import io
